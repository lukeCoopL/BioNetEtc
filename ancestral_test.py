...
branchLength=1
algType="orig"
gf.write_list_to_file([algType],"test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/recent_run")
...
for i in range(7):
    if i in leaves:
        leafGraphs[i]= nx.read_edgelist("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/LEAF"+str(i)+"_two_cherry_branchLength"+str(branchLength)+".txt",create_using=nx.DiGraph)
        ...
        internalGraphs[i]= nx.read_edgelist("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/INTERNAL"+str(i)+"_two_cherry_branchLength"+str(branchLength)+".txt",create_using=nx.DiGraph)
G_anc_dict=dict()
...
plt.savefig("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/EC_scores_branchlength"+str(branchLength)+".png",bbox_inches="tight")
...
plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.savefig("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/S3_scores_branchlength"+str(branchLength)+".png",bbox_inches='tight')
...
plt.legend(bbox_to_anchor=(1.04,0.5), loc="center left", borderaxespad=0)
plt.savefig("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/net_order_scores_branchlength"+str(branchLength)+".png",bbox_inches='tight')
...
plt.savefig("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/conserved_edges_branchlength"+str(branchLength)+".png",bbox_inches="tight")
...
plt.savefig("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/extra_edges_branchlength"+str(branchLength)+".png",bbox_inches="tight")
...
plt.savefig("test_datasets_ancestral/anc50_2cherry_branch"+str(branchLength)+"/missed_edges_branchlength"+str(branchLength)+".png",bbox_inches="tight")
